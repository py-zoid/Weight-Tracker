...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(
        size.width*0.65, size.height*0.75, size.width*0.55, size.height * 0.90);
    path.quadraticBezierTo(
        size.width*0.50, size.height*0.93, size.width*0.45, size.height * 0.90);
    path.quadraticBezierTo(
        size.width*0.55, size.height*0.75, size.width*0.45, size.height * 0.60);
//    path.quadraticBezierTo(
...
//    path.lineTo(size.width*0.75, size.height * 0.65);
    ...
    path.quadraticBezierTo(
        size.width*0.50, size.height*0.95, size.width*0.56, size.height * 0.91);
